...
void ThreadMapPort()
{
   ...
   /* miniupnpc 1.9.20150730 */
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lotuscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"lotuscoin.org", "dnsseed.lotuscoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"lotuscointools.com", "testnet-seed.lotuscointools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lotuscoin is probably already running."), addrBind.ToString().c_str());
        else
